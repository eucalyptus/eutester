...
class AutoScalingBasics(EutesterTestCase):
    ...
    def AutoScalingBasics(self):
        ...
        self.debug("Number of AS groups before create: " + len(self.tester.describe_as_group(self.auto_scaling_group_name)))
        ...
        self.debug("Number of AS groups after create: " + len(self.tester.describe_as_group(self.auto_scaling_group_name)))
