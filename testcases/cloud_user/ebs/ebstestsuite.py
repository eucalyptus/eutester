...
class EbsTestCase(unittest.TestCase):
    ...
    def __init__(self,method, eof=True, *args):
        ...
        self.result=EbsTestResult.not_run
        self.time_to_run=0
        self.eof=True
        self.error = ""
    def run(self):
        try:
            ...
            self.result=EbsTestResult.passed
            return ret
        except Exception, e:
            self.error = str(e)
            self.result = EbsTestResult.failed
            if self.eof:
                raise e
            else:
                pass
...
class EbsTestSuite(unittest.TestCase):
    ...
    def print_test_list_results(self,list=None,printmethod=None):
        ...
        for testcase in list:
            ...
            if testcase.result == EbsTestResult.failed:
